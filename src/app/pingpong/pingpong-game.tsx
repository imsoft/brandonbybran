...
/** Crédito a quien propuso la idea del minijuego (también bajo el título). */
const PINGPONG_GAME_CREDIT = {
  handle: "@brandonbybran",
  url: "https://www.youtube.com/@brandonbybran",
} as const;
...
export default function PingPongGame() {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-4 bg-background px-4">
      ...
      <p className="-mt-1 max-w-md px-2 text-center font-mono text-[10px] leading-tight text-muted-foreground">
        Idea del juego:{" "}
        <a
          href={PINGPONG_GAME_CREDIT.url}
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary/90 underline-offset-2 hover:text-primary hover:underline"
        >
          {PINGPONG_GAME_CREDIT.handle}
        </a>
      </p>
